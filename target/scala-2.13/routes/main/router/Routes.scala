...
class Routes(
  ...
  def documentation = List(
    ...
    ("""GET""", this.prefix + (if(this.prefix.endsWith("/")) "" else "/") + """front""", """controllers.HomeController.front(param:String)"""),
    ("""GET""", this.prefix + (if(this.prefix.endsWith("/")) "" else "/") + """fro""", """controllers.HomeController.notFoundPage"""),
  ...
  // @LINE:10
  private[this] lazy val controllers_HomeController_front3_route = Route("GET",
    PathPattern(List(StaticPart(this.prefix), StaticPart(this.defaultPrefix), StaticPart("front")))
  )
  private[this] lazy val controllers_HomeController_front3_invoker = createInvoker(
    HomeController_1.front(fakeValue[String]),
    play.api.routing.HandlerDef(this.getClass.getClassLoader,
      "router",
      "controllers.HomeController",
      "front",
  ...
  // @LINE:11
  private[this] lazy val controllers_HomeController_notFoundPage4_route = Route("GET",
    PathPattern(List(StaticPart(this.prefix), StaticPart(this.defaultPrefix), StaticPart("fro")))
  )
  private[this] lazy val controllers_HomeController_notFoundPage4_invoker = createInvoker(
    HomeController_1.notFoundPage,
    play.api.routing.HandlerDef(this.getClass.getClassLoader,
      "router",
      "controllers.HomeController",
      "notFoundPage",
  ...
  def routes: PartialFunction[RequestHeader, Handler] = {
    ...
    // @LINE:10
    case controllers_HomeController_front3_route(params@_) =>
      call(params.fromQuery[String]("param", None)) { (param) =>
        controllers_HomeController_front3_invoker.call(HomeController_1.front(param))
      }
  
    // @LINE:11
    case controllers_HomeController_notFoundPage4_route(params@_) =>
      call { 
        controllers_HomeController_notFoundPage4_invoker.call(HomeController_1.notFoundPage)
      }
